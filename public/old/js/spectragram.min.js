...
(function ($, window, document, undefined) {
	...
	var Instagram = {
        ...
        getRecentMedia: function ( userID ) {
			var self = this,
				getData = '/customer/' + userID + '/media/recent/?' + self.accessData.clientID + '&access_token='+ self.accessData.accessToken +'';
      ...
      self.getRecentMedia('self');
			...
			/*	getData = '/customer/search?q=' + self.options.query + '&count=' + self.options.max + '&access_token='+ self.accessData.accessToken + '';
