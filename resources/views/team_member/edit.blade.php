        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                    <img src="{{asset("storage/".$data->image)}}" class="img-fluid" style="max-width: 100%;"/>
                    </div>
                </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route("admin.team_member_update",$data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method("put")
