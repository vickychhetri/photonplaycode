                    ...
                    <div class="card-body ">
                        ...
                        <form method="POST" action="{{ route('admin.blogs.update',$data->id) }}"  enctype="multipart/form-data" >
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea id="schema" type="text" class="form-control @error('schema') is-invalid @enderror" name="schema" required autocomplete="schema" autofocus>{{ old('schema') ?? $data->schema ?? ''}}</textarea>
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-10">
                                    <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug') ?? $data->slug ?? ''}}" required autocomplete="slug" autofocus>
...
{{--                                    <textarea id="keywords" type="text" class="form-control @error('keywords') is-invalid @enderror" name="keywords" required autocomplete="keywords" autofocus>{{ old('keywords') ?? $data->keywords ?? ''}}</textarea>--}}
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-tagsinput/0.8.0/bootstrap-tagsinput.min.js" async defer></script>
