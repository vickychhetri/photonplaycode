...
<body>
<!-- Google Tag Manager (noscript) --> <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-NJZBCGR" height="0" width="0"                   style="display:none;visibility:hidden"></iframe></noscript> <!-- End Google Tag Manager (noscript) -->
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu rounded-3 shadow-lg p-2" aria-labelledby="productDropdown">
                            <li><a class="dropdown-item px-4 py-3 text-black border-bottom hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1200">iCop R1200</a></li>
                            <li><a class="dropdown-item px-4 py-3 text-black border-bottom hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1500">iCop R1500</a></li>
                            <li><a class="dropdown-item px-4 py-3 text-black border-bottom hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1500m">iCop R1500M</a></li>
...
{{--                    src="https://www.photonplay.com/assets/customer/images/logo-dark.png" alt="error" height="30px"></a>--}}
...
{{--                <ul class="navbar-nav me-auto mb-2 mb-lg-0">--}}
{{--                    <li class="nav-item dropdown">--}}
{{--                        <a class="nav-link  active" href="/radar-speed-signs" role="button" data-bs-toggle="dropdown"--}}
{{--                           aria-expanded="false">--}}
{{--                            HOME--}}
{{--                        </a>--}}
{{--                    </li>--}}
{{--                    <li class="nav-item dropdown">--}}
{{--                        <a class="nav-link" href="/company" role="button" data-bs-toggle="dropdown"--}}
{{--                           aria-expanded="false">--}}
{{--                            COMPANY--}}
{{--                        </a>--}}
{{--                    </li>--}}
...
{{--                            PRODUCT--}}
{{--                        </a>--}}
{{--                        <ul class="dropdown-menu rounded-3 shadow-lg p-2">--}}
{{--                            <li><a class="dropdown-item px-4 py-3 text-black border-bottom hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1200">iCop R1200</a></li>--}}
{{--                            <li><a class="dropdown-item px-4 py-3 text-black border-bottom hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1500">iCop R1500</a></li>--}}
{{--                            <li><a class="dropdown-item px-4 py-3 text-black border-bottom hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1500m">iCop R1500M</a></li>--}}
{{--                            <li><a class="dropdown-item px-4 py-3 text-black hover-bg-light" href="https://www.photonplay.com/radar-speed-signs/model/r1800m">iCop R1800M</a></li>--}}
{{--                        </ul>--}}

{{--                    </li>--}}
{{--                    <li class="nav-item dropdown">--}}
{{--                        <a class="nav-link" href="/blogs" role="button" data-bs-toggle="dropdown"--}}
{{--                           aria-expanded="false">--}}
{{--                            News & Media--}}
{{--                        </a>--}}
...
{{--                    </a>--}}
{{--                    <div class="info">--}}
{{--                        <p class="text-white fw-bold">8009669329</p>--}}
{{--                        <p class="text-secondary fs-14 fw-semibold">sales@photonplay.com</p>--}}
{{--                    </div>--}}
{{--                </div>--}}
