...
<section class="pt-0 pb-0">
    <!----------------------- Header ---------------------------->
    <nav class="navbar navbar-expand-lg bg-white pt-2 pb-0 border-bottom">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link text-dark" href="{{route('customer.radar.speed.signs')}}">HOME</a>
                    </li>
                    <li class="nav-item">
...
<li><a class="dropdown-item px-4 py-3 text-black hover-bg-light" href="/radar-cloud-management"> Cloud Software  </a></li>
                ...
                <div class="personal-information d-flex align-items-center gap-2">
                    ...
                    <div class="info">
                        <p class="text-dark fw-bold mb-0">(800) 966-9329</p>
                        <p class="text-muted fs-14 fw-semibold mb-0">sales@photonplay.com</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="form-section pt-0"  id="inquiry"  >
    <div class="container">
        <div class="row">
