                ...
                <div class="card-body">
                    <form method="POST" action="{{route('admin.shipping-rate.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 form-group">
                            ...
                            <div class="col-md-6">
                                <input id="shipping_rate" type="text" class="form-control @error('Postal Code') is-invalid @enderror" name="shipping_rate" value="{{ old('shipping_rate') }}" required autocomplete="title" autofocus>
