                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('admin/edit-profile') }}">
                            ...
                            <div class="row mb-3 form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') ?? $user->email ?? ''}}" required autocomplete="off">
                            ...
                            <div class="password_box">
                                <div class="row mb-3 form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" value="{{ old('password') ?? $user->show_password ?? ''}}" autocomplete="off">
                                ...
                                <div class="row mb-3 form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <input id="password-confirm" type="password" class="form-control" name="confirm_password" value="{{ old('confirm_password') ?? $user->show_password ?? ''}}" autocomplete="off">
