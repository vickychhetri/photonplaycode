                                ...
                                <div class="accordion-body pt-0 acc-spn">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex align-items-center justify-content-center">
                                            <img src="{{asset('assets/customer/images/pvms/Automatic-lift-mechanism-Circle.png')}}"  class="img-fluid h-75" style="max-height: 250px" >
                                        </div>
                            ...
                            <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex align-items-center justify-content-center">
                                            <img src="{{asset('assets/customer/images/pvms/powder-coating-Circle.png')}}" onclick="showModal('{{asset('assets/customer/images/pvms/Secure-and-Vandal-Proof-Circle.png')}}')"  class="img-fluid h-75" style="max-height: 250px" >
                                        </div>
                            ...
                            <div id="flush-collapseThree" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex align-items-center justify-content-center">
                                            <img src="{{asset('assets/customer/images/pvms/Secure-and-Vandal-Proof-Circle.png')}}"  class="img-fluid h-75" style="max-height: 250px" >
                                        </div>
                            ...
                            <div id="flush-collapseTwos" class="accordion-collapse collapse"
                                ...
                                <div class="accordion-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 d-flex align-items-center justify-content-center">
                                            <img src="{{asset('assets/customer/images/pvms/Tonge-Wheel-Jack-2-Circle.png')}}"  class="img-fluid h-75" style="max-height: 250px" >
                                        </div>
                                ...
                                <div id="flush-collapsejack" class="accordion-collapse collapse show"
                                    ...
                                    <div class="accordion-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex align-items-center justify-content-center">
                                                <img src="{{asset('assets/customer/images/pvms/Tonge-Wheel-Jack-Circle.png')}}"  class="img-fluid h-75" style="max-height: 250px" >
                                            </div>
                                ...
                                <div id="flush-collapsejackss" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex align-items-center justify-content-center">
                                                <img src="{{asset('assets/customer/images/pvms/Leveling-Jack-Circle.png')}}"  class="img-fluid h-75" style="max-height: 250px" >
                                            </div>
                                ...
                                <div id="flush-collapsejackfouee" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex align-items-center justify-content-center">
                                                <img src="{{asset('assets/customer/images/pvms/Rugge-Mast-Brake-Circle.png')}}"  class="img-fluid h-75" style="max-height: 250px" >
                                            </div>
                                ...
                                <div id="flush-collapsefender" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex align-items-center justify-content-center" >
                                                <img src="{{asset('assets/customer/images/pvms/Heavy-Duty-Plastic-Fender-Circle.png')}}"  class= "img-fluid h-75" style="max-height: 250px" >
                                            </div>
