    ...
    <div class="container">
        <div class="row">
                    ...
                    <div class="contact-info">
                        <div class="contact-info-item">
                            ...
                            @if (preg_match('/.*(radar-speed-signs).*/', $url_open))
                                <a href="tel:+18009669329" class="font-weight-bold font-f-choose text-dark" style="font-weight: bold;"><img src="{{asset('assets\customer\images\phone.svg')}}" />+1 (800) 966-9329 (US)</a>
                            @else
                            @if ($setting)
                            <a href="tel:{{$setting->sales_phone}}" class="text-decoration-none font-f-choose font-weight-bold text-dark" style="font-weight: bold;"> <i class="bi bi-telephone-inbound-fill text-primary"></i> &nbsp {{$setting->sales_phone}}</a>

                            <a href="tel:{{$setting->support_phone ?? ''}}" class="text-decoration-none font-f-choose font-weight-bold text-dark" style="font-weight: bold;">
                                <i class="bi bi-telephone-inbound-fill text-primary"></i> &nbsp{{$setting->support_phone}}</a>

                            @endif
                            @endif
                            <a href="mailto:{{$setting->sales_email ?? ''}}" class="text-decoration-none font-f-choose font-weight-bold text-dark" style="font-weight: bold;">
            ...
            <div class="col-md-5 rounded p-4 mt-4 " style="background-color: white; " >
                <div class="text-start pb-2">
                    <h3 class="fs-md-2 mt-3 font-f-choose32 text-center" style="font-weight: bold;">Talk to our Radar Experts</h3>
                    <p class="get-in-font-para text-center">Contact our team of experts to suggest you the best product for your radar project.</p>
                </div>
