...
class SignController extends Controller
{
    ...
    public function radarSigns($id)
    {
        ...
        $product = Product::with(['images' => fn ($r) => $r->where('color', 'amber'), 'specilizations.specilization', 'specilizations.options', 'specilizations.options.specializationoptions', 'category','product_resources'])->where('slug', $id)->first();
